        ...
        while cap.isOpened():
            ...
            if result.multi_hand_landmarks and result.multi_handedness:
                for hand_landmarks, handedness in zip(result.multi_hand_landmarks, result.multi_handedness):
                    ...
                    # Get hand center and determine left and right
                    ...
                    for action, value in actions:
                        if action == "volume_up":
                            ...
                            player.set_tempo(conductor.current_tempo_multiplier)
            ...
            cv2.imshow("Conductify - Advanced Gesture Control", frame)
